...
eststo clear
estpost ttest currently_emp usually_emp work_hours nonwork_hours ever_school years_of_edu age hindu brahmin_chhetri if nlfs_year == 1998, by(treatment)
...
eststo :reg currently_emp i.post i.treatment post#treatment, r


eststo: logit currently_emp i.post i.treatment post#treatment
...
esttab using "Data Presentation/logit_reg1.tex", 
  ...
  mtitles("LPM" "Logit") /// Column Titles
